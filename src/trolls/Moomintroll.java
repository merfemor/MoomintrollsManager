...
public class Moomintroll extends Wight implements BowTo, Emotionable, Comparable<Moomintroll>, Serializable {
    ...
    public Moomintroll(String name, boolean isMale, long position, Color bodyColor, Kindness kindness, ZonedDateTime creationDateTime) {
        super(name);
        this.isMale = isMale;
    ...
    @Override
    public void moveTo(long position, int maxDistance) {
    ...
    public int compareTo(Moomintroll moomintroll) {
        ...
        if (moomintroll.position - this.position > 0)
            return 1;
        else if (moomintroll.position == this.position)
            return 0;
        else
            return -1;
    }
